...
import time
#  Build  2-hidden  layer  network  with  400  and  200  hidden  units respectively with following configuration: 
# Input →linear1→batch normalization→dropout (0.25) →ReLU→linear2→output
