...
import time
# A 2-hidden layer network with 400 units in the first hidden layer  and  200  units  in  the  second  hidden  layer,  respectively.  Use  the  ReLU  activation between the input and hidden layer-1, and between the hidden layer-1 and hidden layer-2

class NNet3(nn.Module):
    def __init__(self):
        super(NNet3, self).__init__()
        self.input_size = 28*28
        self.L1 = nn.Linear(self.input_size, 400) 
